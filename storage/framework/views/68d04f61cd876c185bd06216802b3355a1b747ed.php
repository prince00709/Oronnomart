                                ...
                                <a class="dropdown-toggle no-arrow text-secondary fs-12" data-toggle="dropdown"
                                    ...
                                    <span class="position-relative d-inline-block">
                                        ...
                                        <?php if(Auth::check() && count($user->unreadNotifications) > 0): ?>
                                            <span class="badge badge-primary badge-inline badge-pill absolute-top-right--10px unread-notification-count"><?php echo e(count($user->unreadNotifications)); ?></span>
                                        <?php endif; ?>
                                    </span>
                                </a>
                                                        ...
                                                        <div class="d-flex">
                                                            ...
                                                            <div>
                                                                ...
                                                                <?php if($isLinkable = true): ?>
                                                                    <a href="<?php echo e(route('notification.read-and-redirect', encrypt($notification->id))); ?>">
                                                                <?php endif; ?>
                                                                    <span class="fs-12 text-dark text-truncate-2"><?php echo $notifyContent; ?></span>
                                                                <?php if($isLinkable = true): ?>
                                                                    </a>
                                                                <?php endif; ?>
                                                            </div>
                            ...
                            <div class="d-flex align-items-center justify-content-between">
                                <div>
                                    ...
                                    <a href="<?php echo e(route('categories.all')); ?>" class="text-reset categoriesAll">
                                        <span
                                            class="d-none d-lg-inline-block text-white animate-underline-white">(<?php echo e(translate('See All')); ?>)</span>
                                    </a>
                                </div>
...
<?php /**PATH /home1/demo4axiz/public_html/Oronnomart/resources/views/frontend/inc/nav.blade.php ENDPATH**/ ?>
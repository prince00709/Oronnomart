    ...
    <div class="aiz-sidebar left c-scrollbar">
        ...
        <div class="aiz-side-nav-wrap">
            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view_all_unpaid_orders')): ?>
                                <li class="aiz-side-nav-item">
                                    <a href="<?php echo e(route('unpaid_orders.index')); ?>" class="aiz-side-nav-link <?php echo e(areActiveRoutes(['unpaid_orders.index'])); ?>">
                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view_all_customers')): ?>
                                <li class="aiz-side-nav-item">
                                    <a href="<?php echo e(route('customers.index')); ?>" class="aiz-side-nav-link <?php echo e(areActiveRoutes(['customers.create'])); ?>">
                ...
                <!-- Reports -->
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['earning_report', 'in_house_product_sale_report','seller_products_sale_report','products_stock_report','product_wishlist_report','user_search_report','commission_history_report','wallet_transaction_report'])): ?>
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            <div class="aiz-side-nav-icon">
                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view_all_dynamic_popups')): ?>
                                <li class="aiz-side-nav-item">
                                    <a href="<?php echo e(route('dynamic-popups.index')); ?>" class="aiz-side-nav-link <?php echo e(areActiveRoutes(['dynamic-popups.index', 'dynamic-popups.create', 'dynamic-popups.edit'])); ?>">
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view_all_custom_alerts')): ?>
                                <li class="aiz-side-nav-item">
                                    <a href="<?php echo e(route('custom-alerts.index')); ?>" class="aiz-side-nav-link <?php echo e(areActiveRoutes(['custom-alerts.index', 'custom-alerts.create', 'custom-alerts.edit'])); ?>">
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage_email_templates')): ?>
                                <li class="aiz-side-nav-item">
                                    ...
                                    <ul class="aiz-side-nav-list level-3">
                                        ...
                                        <li class="aiz-side-nav-item">
                                            <a href="<?php echo e(route('email-templates.index', 'customer')); ?>" class="aiz-side-nav-link">
                                ...
                                <li class="aiz-side-nav-item">
                                    ...
                                    <ul class="aiz-side-nav-list level-3">
                                        ...
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view_all_notification_types')): ?>
                                            <li class="aiz-side-nav-item">
                                                <a href="<?php echo e(route('notification-type.index')); ?>" class="aiz-side-nav-link <?php echo e(areActiveRoutes(['notification-type.edit'])); ?>">
                ...
                <?php if(addon_is_activated('offline_payment')): ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['view_all_manual_payment_methods','view_all_offline_payment_orders', 'view_all_offline_wallet_recharges','view_all_offline_customer_package_payments','view_all_offline_seller_package_payments'])): ?>
                        <li class="aiz-side-nav-item">
                            <a href="#" class="aiz-side-nav-link">
                                <div class="aiz-side-nav-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
...
<?php /**PATH /home1/demo4axiz/public_html/Oronnomart/resources/views/backend/inc/admin_sidenav.blade.php ENDPATH**/ ?>
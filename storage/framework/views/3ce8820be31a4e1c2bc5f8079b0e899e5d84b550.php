<div class="aiz-card-box border border-light rounded hov-shadow-md mt-1 mb-2 has-transition bg-white">
    ...
    <div class="p-md-3 p-2 text-center">
        ...
        <div class="fs-15">
           <?php if($product->app_price): ?>
            <span class="fw-700 text-primary">App price: ৳<?php echo e($product->app_price); ?></span>
            <?php else: ?>
...
<?php /**PATH D:\xampp8.2.12\htdocs\Oronnomart\resources\views/frontend/classic/partials/product_box_1.blade.php ENDPATH**/ ?>
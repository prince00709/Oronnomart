<?php
    $best_selers = Cache::remember('best_selers', 86400, function () {
        return \App\Models\Seller::where('verification_status', 1)->orderBy('num_of_sale', 'desc')->take(12)->get();
    });   
?>
...
<?php endif; ?>
<?php /**PATH D:\xampp8.2.12\htdocs\Oronnomart\resources\views/frontend/classic/partials/best_sellers_section.blade.php ENDPATH**/ ?>
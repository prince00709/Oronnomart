				...
				<div class="card-body">
					<form action="<?php echo e(route('brands.store')); ?>" method="POST">
						...
						<div class="form-group mb-3">
                            ...
                            <small class="text-muted"><?php echo e(translate('Minimum dimensions required: 126px width X 100px height.')); ?></small>
						</div>
						<div class="form-group mb-3">
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/demo4axiz/public_html/Oronnomart/resources/views/backend/product/brands/index.blade.php ENDPATH**/ ?>
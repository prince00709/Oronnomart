<?php $__env->startSection('content'); ?>
    <div class="aiz-titlebar text-left mt-2 mb-3">
        <div class=" align-items-center">
            <h1 class="h3"><?php echo e(translate('Earning Report')); ?></h1>
        </div>
    </div>
    ...
    <div class="row gutters-16">
                        ...
                        <div class="d-flex flex-column justify-content-between h-100">
                            <div class="">
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <h1 class="fs-30 fw-600 text-dark mb-1">
                                            <?php echo e(single_price($total_sales_alltime)); ?>

                                        </h1>
                                        <h3 class="fs-13 fw-600 text-secondary mb-0"><?php echo e(translate('Total Sales Alltime')); ?></h3>
                                    </div>
                                    <div class="mt-2">
                                ...
                                <div
                                    ...
                                    <h3 class="fs-13 fw-600 mb-0">
                                        <?php echo e(single_price($sales_this_month)); ?>
                        ...
                        <div class="d-flex flex-column justify-content-between h-100">
                            <div class="">
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <h1 class="fs-30 fw-600 text-dark mb-1">
                                            <?php echo e(single_price($total_payouts)); ?>

                                        </h1>
                                        <h3 class="fs-13 fw-600 text-secondary mb-0"><?php echo e(translate('Payouts')); ?></h3>
                                    </div>
                                    <div class="mt-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32"
                                            viewBox="0 0 32 32">
                                ...
                                <div
                                    ...
                                    <h3 class="fs-13 fw-600 mb-0">
                                        <?php echo e(translate('Payouts this month')); ?>

                                    </h3>
                                    <h3 class="fs-13 fw-600 mb-0">
                                        <?php echo e(single_price($payout_this_month)); ?>
            ...
            <div class="dashboard-box bg-white mb-2rem overflow-hidden p-2rem" style="">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-3">
                    <div class="mb-3 mb-sm-0">
                        <h2 class="fs-16 fw-600 text-soft-dark mb-2"><?php echo e(translate('Net Sales')); ?></h2>
                        <h4 class="fs-13 fw-600 text-secondary mb-0"><?php echo e(translate('By Sale Category')); ?></h4>
                    </div>
                    <!-- nav -->
        ...
        <div class="col-lg-6">
            <div class="dashboard-box bg-white mb-2rem overflow-hidden p-2rem" style="">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-3">
                    <div class="mb-3 mb-sm-0">
                        <h2 class="fs-16 fw-600 text-soft-dark mb-2"><?php echo e(translate('Payouts')); ?></h2>
                        <h4 class="fs-13 fw-600 text-secondary mb-0"><?php echo e(translate('By Expense Category')); ?></h4>
                    </div>
                    <!-- nav -->
                    <ul class="nav nav-tabs dashboard-tab dashboard-tab-danger border-0" role="tablist"
                        aria-orientation="vertical">
        ...
        <div class="col-lg-6">
            <div class="dashboard-box bg-white mb-2rem overflow-hidden p-2rem" style="">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-3">
                    <div class="mb-3 mb-sm-0">
                        <h2 class="fs-16 fw-600 text-soft-dark mb-2"><?php echo e(translate('Sale Analytics')); ?></h2>
                    </div>
                    <!-- nav -->
                    <ul class="nav nav-tabs dashboard-tab dashboard-tab-danger border-0" role="tablist"
                        aria-orientation="vertical">
        ...
        <div class="col-lg-6">
            <div class="dashboard-box bg-white mb-2rem overflow-hidden p-2rem" style="">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-3">
                    <div class="mb-3 mb-sm-0">
                        <h2 class="fs-16 fw-600 text-soft-dark mb-2"><?php echo e(translate('Payouts Analytics')); ?></h2>
                    </div>
                    <!-- nav -->
                    <ul class="nav nav-tabs dashboard-tab dashboard-tab-danger border-0" role="tablist"
                        aria-orientation="vertical">
...
<?php $__env->startSection('script'); ?>
    <script type="text/javascript">
            ...
            data: {
                labels: [
                    <?php $__currentLoopData = $sales_stat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        "<?php echo e($row['time']); ?> <?php echo e($row['formatted_price']); ?>",
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ],
                datasets: [{
                    fill: false,
        ...
        AIZ.plugins.chart('#graph-2', {
            ...
            data: {
                labels: [
                    <?php $__currentLoopData = $payout_stat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        "<?php echo e($row['time']); ?> <?php echo e($row['formatted_price']); ?>",
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ],
                datasets: [{
        ...
        net_sales_chart = new Chart(net_sales_graph, {
            ...
            data: {
                labels: [
                    "<?php echo e(translate('Product Sales')); ?>",
                    "<?php echo e(translate('Commission')); ?>",
                    "<?php echo e(translate('Seller Subscription')); ?>",
                    "<?php echo e(translate('Customer Subscription')); ?>",
        ...
        payouts_chart = new Chart(payouts_graph, {
            type: 'bar',
            data: {
                labels: ["<?php echo e(translate('Seller Payout')); ?>", "<?php echo e(translate('Product Refund')); ?>", "<?php echo e(translate('Delivery Boy')); ?>"],
                datasets: [{
                    axis: 'y',
                    data: [],
                    backgroundColor: [
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/demo4axiz/public_html/Oronnomart/resources/views/backend/reports/earning_payout_report.blade.php ENDPATH**/ ?>